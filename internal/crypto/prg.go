...
// using a deterministic random bit generator (DRBG) as
// specified by NIST - Special Publication 800-90A Revision
// 1. Blake3 is not normally used as a DRBG but we've applied
