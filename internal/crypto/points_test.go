...
func TestScalarMult(t *testing.T) {
	for i, e := range scalarMultTests {
		...
		if !arePointsEqual(kPoint, &Point{x: expectedX, y: expectedY}) {
...
func TestSub(t *testing.T) {
	for i, e := range addTests {
		...
		diff := sum.Sub(point)
		if !arePointsEqual(diff, &Point{x: expectedX, y: expectedY}) {
...
func TestMarshalUnmarshal(t *testing.T) {
	for i, e := range keyMarshalTests {
		...
		if !arePointsEqual(point, unmarshalPoint) {
